	...
	'counter_options' => array(
		...
		'options' => array(
			'number'                  => array(
				'type'  => 'text',
				'value' => 10,
				'label' => esc_html__( 'Count To Number', 'weldo' ),
				'desc'  => esc_html__( 'Choose value to count to', 'weldo' ),
			),
			'number_color'     => array(
				'type'    => 'select',
				'value'   => 'color-main',
				'label'   => esc_html__( 'Number text color', 'weldo' ),
				'desc'    => esc_html__( 'Select a color for your number', 'weldo' ),
				'choices' => array(
			...
			'number_size'            => array(
				'type'    => 'select',
				'value'   => 'fs-50',
				'label'   => esc_html__( 'Number Size', 'weldo' ),
				'desc'    => esc_html__( 'Select a size for number', 'weldo' ),
				'choices' => array(
			...
			'counter_additional_text' => array(
				'type'  => 'text',
				'value' => '',
				'label' => esc_html__( 'Add some text after counter', 'weldo' ),
				'desc'  => esc_html__( 'You can add "+", "%", decimal values etc.', 'weldo' ),
			),
			'speed'                   => array(
				'type'       => 'slider',
				'value'      => 1000,
				...
				'label'      => esc_html__( 'Counter Speed (counter teaser only)', 'weldo' ),
				'desc'       => esc_html__( 'Choose counter speed (in milliseconds)', 'weldo' ),
			),
		),
	),
	'show_border' => array(
		'type'         => 'switch',
		'label'        => esc_html__( 'Show Right Border', 'weldo' ),
		'desc'        => esc_html__( 'Show or hide right border on icon box', 'weldo' ),
		'left-choice'  => array(
			'value' => '',
			'label' => esc_html__( 'No', 'weldo' ),
		),
		'right-choice' => array(
			'value' => 'box-border-right',
