...
?>
<article <?php post_class( "vertical-item item-post-tiled2 w-100 " . $filter_classes ); ?>>
	<?php if ( get_the_post_thumbnail() ) : ?>
		<div class="item-media">
			<?php
			echo get_the_post_thumbnail('','weldo-blog-width','');
			?>
	...
	<div class="item-content">
		<?php if ( function_exists( 'weldo_the_date' ) ) {
			weldo_the_date( array(
				'before'          => '<div class="post-date mb-10"><i class="fs-14 ico ico-clock-alt mr-2"></i>',
				'after'           => '</div>',
			...
			<span class="byline">
				...
				if ( function_exists( 'weldo_comments_counter' ) ) {
					weldo_comments_counter( array(
						'before'              => '<span class="comments-link"><i class="fs-14 ico ico-comment-alt"></i>',
						'after'               => '</span>',
						'comment'             => 'comment',
						'comments'            => 'comments',
        ...
        <a class="mt-15 btn btn-outline-maincolor btn-wide btn-small read-more" href="<?php the_permalink(); ?>"> <?php esc_html_e( 'Read More', 'weldo' ); ?></a>
	</div>
