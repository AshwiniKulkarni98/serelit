...
?>
<article <?php post_class( "vertical-item item-post " . $filter_classes  ); ?>>
    ...
    <div class="item-content">
        ...
        <a class="mt-23 btn btn-outline-maincolor btn-wide btn-small read-more" href="<?php the_permalink(); ?>"> <?php esc_html_e( 'Read More', 'weldo' ); ?></a>
    </div>
