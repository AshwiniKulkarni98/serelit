...
$options = array(
	'slide_video'  => array(
		'desc'        => esc_html__( 'Upload a HTML5 video', 'weldo' ),
		'images_only' => false,
		'type'        => 'upload',
		'no-validate' => false,
	),
	'heading'                  => array(
		...
		'picker'  => array(
			'show_heading' => array(
				'type'         => 'switch',
				'label'        => esc_html__( 'Slide heading', 'weldo' ),
				'desc'         => esc_html__( 'The heading will appear on the slide layer behind the text', 'weldo' ),
				'left-choice'  => array(
					'value' => '',
		...
		'choices' => array(
			...
			'heading' => array(
				...
				'heading-type' => array(
					'type'    => 'radio',
					'value'   => 'stroke-heading',
					'label'   => esc_html__( 'Heading Type', 'weldo' ),
					'desc'    => esc_html__( 'Select the type of heading style', 'weldo' ),
					'choices' => array(
						'stroke-heading' => esc_html__( 'Stroke Heading', 'weldo' ),
						'shadow-heading' => esc_html__( 'Shadow Heading', 'weldo' ),
					),
					'inline'  => true,
				)
			),
