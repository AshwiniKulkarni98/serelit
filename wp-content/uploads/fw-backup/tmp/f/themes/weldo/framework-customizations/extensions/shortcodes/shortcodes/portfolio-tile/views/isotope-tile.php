...
<div class="isotope-wrapper isotope row c-mb-30 c-gutter-30"
	...
	<?php while ( $posts->have_posts() ) : $posts->the_post();
		...
		$column_class = ( $counter == 2 || $counter == 7 || $counter == 12 ) ? 'col-lg-8' : 'col-lg-4';
		?>
				...
				<div class="vertical-item item-gallery content-absolute text-center ds ms">
					<div class="item-media">
						...
						if ( $counter == 2 || $counter == 7 || $counter == 12 ) {
							the_post_thumbnail( 'weldo-portfolio-shortcode-tile-half-square-horizontal' );
						} else {
							the_post_thumbnail( 'weldo-portfolio-shortcode-tile-square' );
						}
						?>
