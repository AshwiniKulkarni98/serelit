...
if ( ! function_exists( 'oc_cb_scripts_admin' ) ) {
	function oc_cb_scripts_admin( $hook_suffix ) {
		...
		if ( $hook_suffix === 'one-com_page_onecom-wp-cookie-banner'
			|| $hook_suffix === 'adminone-com_page_onecom-wp-cookie-banner'
			|| $hook_suffix === 'one-com_page_onecom-wp-error-page'
		) {
...
if ( ! function_exists( 'oc_cookie_banner_notice' ) ) {
	function oc_cookie_banner_notice() {
		...
		$skip_screens = array(
			'one-comone-com_page_onecom-wp-cookie-banner',
			/* 'plugins', */
		);
