...
class FW_Shortcode_Portfolio_Tile extends FW_Shortcode {
	...
	public static function add_portfolio_tile_image_sizes() {
		add_image_size( 'weldo-portfolio-shortcode-tile-square', 1100, 1190, true );
		add_image_size( 'weldo-portfolio-shortcode-tile-half-square-horizontal', 1350, 700, true );
	}
	...
	private function get_error_msg() {
		return '<p>' . esc_html__( 'No view found', 'weldo' ) . '</p>';
	}
}