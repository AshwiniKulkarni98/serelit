...
class FW_Extension_Team extends FW_Extension {
	...
	public function _action_register_post_type() {
		...
		$post_names = apply_filters( 'fw_ext_team_post_type_name',
			array(
				'singular' => __( 'Team member', 'mwt' ),
				'plural'   => __( 'Team members', 'mwt' )
			) );
		...
		register_post_type( $this->post_type,
			array(
				...
				'description'        => __( 'Create a team item', 'mwt' ),
				'public'             => true,
				'show_ui'            => true,
				'show_in_menu'       => true,
			...
			if ( $post_type === $this->post_type ) {
				...
				$options[] = array(
					'member_meta_tab' => array(
						'title'   => __( 'Member Meta', 'mwt' ),
						'type'    => 'box',
						'options' => array(
							'tab_position' => array(
								'title'   => __( 'Member position', 'mwt' ),
								'type'    => 'tab',
								'options' => array(
									'position' => array(
										'title'   => __( 'Member position name', 'mwt' ),
										'type'    => 'text',
									),
									'subheading' => array(
							...
							'tab_form' => array(
								'title'   => __( 'Contact Form Tab', 'mwt' ),
								'type'    => 'tab',
								'options' => array(
									'button_label'       => array(
										'label' => esc_html__( 'Contact Button Label', 'mwt' ),
										'desc'  => esc_html__( 'This is the text that appears on your button', 'mwt' ),
										'type'  => 'text',
										'value' => esc_html__('Submit', 'mwt' ),
									),
									$contact_form,
								),
							),
					...
					'additional_content_box' => array(
						'title'   => __( 'Below tabs content', 'mwt' ),
						'type'    => 'box',
						'options'    => array(
							'additional_content' => array(
								'type'        => 'wp-editor',
								'value'       => '',
								'label'       => __( 'Text below member meta tabs', 'mwt' ),
								'wpautop'     => true,
								'size'        => 'large',
